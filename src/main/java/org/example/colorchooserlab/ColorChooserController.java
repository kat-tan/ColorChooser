package org.example.colorchooserlab;
...
//                blueSlider.valueProperty().asString("%.0f"));
        ...
        // bidirectional binds between the TextField values and the Slider value so updates
        // when one or the other is changed
        redTextField.textProperty().bindBidirectional(redSlider.valueProperty(),
                new NumberStringConverter());
        greenTextField.textProperty().bindBidirectional(greenSlider.valueProperty(),
                new NumberStringConverter());
        blueTextField.textProperty().bindBidirectional(blueSlider.valueProperty(),
                new NumberStringConverter());
